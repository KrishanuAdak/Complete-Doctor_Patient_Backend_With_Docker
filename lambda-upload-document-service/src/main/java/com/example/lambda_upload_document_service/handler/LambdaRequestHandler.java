...
import com.example.lambda_upload_document_service.repository.DocumentUploadRepo;

public class LambdaRequestHandler implements RequestHandler<S3Event, String> {
    private static final DocumentUploadRepo repository = new DocumentUploadRepo();
