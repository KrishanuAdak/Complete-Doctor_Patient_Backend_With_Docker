...
public class DoctorTool {
    @Tool(name = "available_doctors_today",
     value = "Get a list of doctors available today when user ask for specific location or city but these doctors are only available in mecheda not for other city")
